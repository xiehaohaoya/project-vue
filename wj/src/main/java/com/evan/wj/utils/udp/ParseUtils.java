...
//        frameBuffer.append("0E");
     ...
     * @return
     */
    public String parseFrame(CopyOnWriteArrayList<String> frameHeaderFieldsList, String hexFrameStr) {
        // TODO 用两个list来存放 变量名字和字段值，frameHeaderFieldsList，fieldsNameList，headerValuesList的index是对应样的
        CopyOnWriteArrayList<String> headerFieldsNameList = new CopyOnWriteArrayList();
        CopyOnWriteArrayList<Object> headerValuesList = new CopyOnWriteArrayList();
